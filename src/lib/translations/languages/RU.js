		...
		projects: {
			...
			subjects: [
				...
				/* CONSOFY */ {
					...
					time: "2025",
					content: `ConsoFy — это простой инструмент для организации и стилизации консоли JavaScript. Название ConsoFy было выбрано из-за схожести со словом "console", используемым в JavaScript, что делает использование более интуитивным. Доступ: ${defaults.link("npmjs.com/package/consofy", "https://www.npmjs.com/package/consofy")}`
				}
		...
		projectsPlus: {
			...
			subjects: [
				...
				/* LDP WHATSAPP */ {
					...
					type: "Личный проект",
					time: "В РАЗРАБОТКЕ",
					content: `LDP WhatsApp — это разрабатываемая система для управления производственной линией товаров или услуг, с чатом с клиентом через WhatsApp прямо в системе. Частный проект, всё ещё в разработке.`
				}
			]
		},
		works: {
