...
export default {
	...
	content: {
		...
		notFound: "Страница, которую вы пытались открыть, не найдена или не существует.",
		useLinksToGoHome: "Используйте одну из ссылок ниже, чтобы перейти на существующую страницу.",
		errorInLoading: "Ошибка загрузки страницы. Пожалуйста, попробуйте позже.<br><br>Код ошибки:",
